...
backend_cpu="${DEERFLOW_BACKEND_CPU:-2}"
backend_memory="${DEERFLOW_BACKEND_MEMORY:-4Gi}"
backend_concurrency="${DEERFLOW_BACKEND_CONCURRENCY:-10}"
backend_min_instances="${DEERFLOW_BACKEND_MIN_INSTANCES:-1}"
backend_max_instances="${DEERFLOW_BACKEND_MAX_INSTANCES:-1}"
...
frontend_min_instances="${DEERFLOW_FRONTEND_MIN_INSTANCES:-1}"
